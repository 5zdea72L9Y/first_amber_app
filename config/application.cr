...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "First Amber App web application."
  #
  #
  ...
  #
  # settings.secret_key_base= rDugeHLYZnYk4aq0U_DfnuFMos5jQ0NXR-5sDyFVyLQ
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("first_amber_app.log", "w"))
  #
  #
end
